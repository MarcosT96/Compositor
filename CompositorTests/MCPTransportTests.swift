...
struct MCPTransportTests {
    ...
    @Test func toolsListExposesNativeToolCatalog() async throws {
        ...
        for expected in ["layer_operation", "paint_stroke", "render_document", "import_html", "history_operation", "read_skill", "manage_skills", "generate_image", "manage_generations", "list_models", "manage_credentials"] {
